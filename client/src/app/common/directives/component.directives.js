(function() {
        ...
        return {
            link: function(scope, element) {
                var listener = function(event, toState, toParams, fromState, fromParams) {
                    ...
                    if (toState.data && toState.data.pageTitle) title = 'NYC | ' + toState.data.pageTitle;
                    $timeout(function() {
                        element.text(title);
                    });
                };
    ...
    function minimalizaSidebar($timeout) {
        return {
            restrict: 'A',
            //template: '<a class="navbar-minimalize " href="" ng-click="minimalize()"><i class="fa fa-sun-o fa-3x"></i></a>',
            template: '<div class="navbar-minimalize " href="" ng-click="minimalize()"><i class="material-icons menu-icon">menu</i></div>',
