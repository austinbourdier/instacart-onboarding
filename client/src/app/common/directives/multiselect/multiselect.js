//demo at:  https://codepen.io/long2know/pen/PqLRyZ
        ...
        return {
            ...
            link: function (originalScope, element, attrs, ctrls) {
                ...
                var
                    ...
                    selectedHeader = attrs.selectedHeader,
                    ...
                    getHeaderText = function () {
                        ...
                        if (isEmpty(modelCtrl.$modelValue) || !selectedHeader) return scope.header = localHeader;
                        if (isMultiple) {
